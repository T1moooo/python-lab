# ============================================================
# Day 6: Multi-Agent Writing Team — 详细注释版
# ============================================================
#
# 今天学习"多 Agent 协作"：多个 Agent 各司其职，协同完成任务
#
# 角色分工：
#   - 研究员（Researcher）：收集资料
#   - 写手（Writer）：撰写文章
...
# ------------------------------------------------------------
#
# 每个 Agent 有自己的 system_prompt，定义了它的职责和输出格式
# 这是多 Agent 协作的核心：通过不同的 prompt 赋予不同的角色
...
def call_llm(role: str, content: str) -> str:
    ...
    不同的角色使用不同的 system_prompt
    这样同一个 LLM 可以扮演不同的 Agent
